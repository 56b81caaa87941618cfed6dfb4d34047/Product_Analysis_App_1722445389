...
*/
Vue.component("simple_footer_component_1722445393", {
    template: `
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Gain valuable data-driven insights on new products with our intelligent analysis app. Stay ahead of trends and make informed decisions.
                    </div>
                </div>
            </div>
        </footer> 
